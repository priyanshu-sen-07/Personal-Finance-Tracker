...
class CSV:
    ...
    def get_transactions(cls,start_date,end_date):
        ...
        df['date'] = pd.to_datetime(df['date'], format =CSV.FORMAT,dayfirst=True, errors='coerce')
        ...
        if filtered_df.empty:
            print("No transaction found between given dates")
        else:
...
def add():
    CSV.initialize_csv()
    date = get_date("Enter the date of the transaction (dd-mm-yy) or enter for today's date: ", allow_default=True)
    amount = get_amount()
